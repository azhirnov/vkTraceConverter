...
switch ( iter->packet_id )
{
	...
	case VKTRACE_TPI_VK_vkGetPhysicalDeviceExternalImageFormatPropertiesNV : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.physicalDevice), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCmdDrawIndirectCountAMD : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT, ResourceID(packet.commandBuffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(packet.buffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(packet.countBuffer), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDebugReportCallbackEXT : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_INSTANCE_EXT, ResourceID(packet.instance), iter, frame_id );
	...
	case VKTRACE_TPI_VK_vkDebugMarkerSetObjectTagEXT : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		if ( packet.pTagInfo ) {
	...
	case VKTRACE_TPI_VK_vkCreateInstance : {
		...
		if ( packet.pInstance ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_INSTANCE_EXT, ResourceID(*packet.pInstance), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkEnumeratePhysicalDevices : {
		...
		for (uint a = 0; packet.pPhysicalDevices and &packet.pPhysicalDeviceCount[0] and a < packet.pPhysicalDeviceCount[0]; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.pPhysicalDevices[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDevice : {
		...
		if ( packet.pDevice ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(*packet.pDevice), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetDeviceQueue : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		if ( packet.pQueue ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_QUEUE_EXT, ResourceID(*packet.pQueue), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkQueueSubmit : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_QUEUE_EXT, ResourceID(packet.queue), iter, frame_id );
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_FENCE_EXT, ResourceID(packet.fence), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkAllocateMemory : {
		...
		if ( packet.pMemory ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_MEMORY_EXT, ResourceID(*packet.pMemory), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkFreeMemory : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_MEMORY_EXT, ResourceID(packet.memory), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkBindImageMemory : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, ResourceID(packet.image), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_MEMORY_EXT, ResourceID(packet.memory), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateFence : {
		...
		if ( packet.pFence ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_FENCE_EXT, ResourceID(*packet.pFence), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkResetFences : {
		...
		for (uint a = 0; packet.pFences and &packet.fenceCount and a < packet.fenceCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_FENCE_EXT, ResourceID(packet.pFences[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateSemaphore : {
		...
		if ( packet.pSemaphore ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SEMAPHORE_EXT, ResourceID(*packet.pSemaphore), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroySemaphore : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SEMAPHORE_EXT, ResourceID(packet.semaphore), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateEvent : {
		...
		if ( packet.pEvent ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_EVENT_EXT, ResourceID(*packet.pEvent), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyEvent : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_EVENT_EXT, ResourceID(packet.event), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateQueryPool : {
		...
		if ( packet.pQueryPool ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_QUERY_POOL_EXT, ResourceID(*packet.pQueryPool), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyQueryPool : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_QUERY_POOL_EXT, ResourceID(packet.queryPool), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateBuffer : {
		...
		if ( packet.pBuffer ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(*packet.pBuffer), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateBufferView : {
		...
		if ( packet.pView ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_VIEW_EXT, ResourceID(*packet.pView), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyBufferView : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_VIEW_EXT, ResourceID(packet.bufferView), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateImage : {
		...
		if ( packet.pImage ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, ResourceID(*packet.pImage), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateImageView : {
		...
		if ( packet.pView ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_VIEW_EXT, ResourceID(*packet.pView), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyImageView : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_VIEW_EXT, ResourceID(packet.imageView), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateShaderModule : {
		...
		if ( packet.pShaderModule ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT, ResourceID(*packet.pShaderModule), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyShaderModule : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT, ResourceID(packet.shaderModule), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreatePipelineCache : {
		...
		if ( packet.pPipelineCache ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_CACHE_EXT, ResourceID(*packet.pPipelineCache), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyPipelineCache : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_CACHE_EXT, ResourceID(packet.pipelineCache), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkMergePipelineCaches : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_CACHE_EXT, ResourceID(packet.dstCache), iter, frame_id );
		for (uint a = 0; packet.pSrcCaches and &packet.srcCacheCount and a < packet.srcCacheCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_CACHE_EXT, ResourceID(packet.pSrcCaches[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateGraphicsPipelines : {
		...
		if ( packet.pPipelines ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT, ResourceID(*packet.pPipelines), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyPipeline : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT, ResourceID(packet.pipeline), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreatePipelineLayout : {
		...
		if ( packet.pPipelineLayout ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_LAYOUT_EXT, ResourceID(*packet.pPipelineLayout), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyPipelineLayout : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_LAYOUT_EXT, ResourceID(packet.pipelineLayout), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateSampler : {
		...
		if ( packet.pSampler ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SAMPLER_EXT, ResourceID(*packet.pSampler), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroySampler : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SAMPLER_EXT, ResourceID(packet.sampler), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDescriptorSetLayout : {
		...
		if ( packet.pSetLayout ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT_EXT, ResourceID(*packet.pSetLayout), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyDescriptorSetLayout : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT_EXT, ResourceID(packet.descriptorSetLayout), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDescriptorPool : {
		...
		if ( packet.pDescriptorPool ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_POOL_EXT, ResourceID(*packet.pDescriptorPool), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyDescriptorPool : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_POOL_EXT, ResourceID(packet.descriptorPool), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkAllocateDescriptorSets : {
		...
		for (uint a = 0; packet.pDescriptorSets and &packet.pAllocateInfo->descriptorSetCount and a < packet.pAllocateInfo->descriptorSetCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_EXT, ResourceID(packet.pDescriptorSets[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateFramebuffer : {
		...
		if ( packet.pFramebuffer ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_FRAMEBUFFER_EXT, ResourceID(*packet.pFramebuffer), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyFramebuffer : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_FRAMEBUFFER_EXT, ResourceID(packet.framebuffer), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateRenderPass : {
		...
		if ( packet.pRenderPass ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_RENDER_PASS_EXT, ResourceID(*packet.pRenderPass), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyRenderPass : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_RENDER_PASS_EXT, ResourceID(packet.renderPass), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateCommandPool : {
		...
		if ( packet.pCommandPool ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_POOL_EXT, ResourceID(*packet.pCommandPool), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyCommandPool : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_POOL_EXT, ResourceID(packet.commandPool), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkAllocateCommandBuffers : {
		...
		for (uint a = 0; packet.pCommandBuffers and &packet.pAllocateInfo->commandBufferCount and a < packet.pAllocateInfo->commandBufferCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT, ResourceID(packet.pCommandBuffers[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCmdBindDescriptorSets : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT, ResourceID(packet.commandBuffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_LAYOUT_EXT, ResourceID(packet.layout), iter, frame_id );
		for (uint a = 0; packet.pDescriptorSets and &packet.descriptorSetCount and a < packet.descriptorSetCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_EXT, ResourceID(packet.pDescriptorSets[a]), iter, frame_id );
		}
		break;
	...
	case VKTRACE_TPI_VK_vkCmdBindVertexBuffers : {
		...
		for (uint a = 0; packet.pBuffers and &packet.bindingCount and a < packet.bindingCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(packet.pBuffers[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCmdCopyBuffer : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT, ResourceID(packet.commandBuffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(packet.srcBuffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT, ResourceID(packet.dstBuffer), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCmdCopyImage : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT, ResourceID(packet.commandBuffer), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, ResourceID(packet.srcImage), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, ResourceID(packet.dstImage), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCmdWaitEvents : {
		...
		for (uint a = 0; packet.pEvents and &packet.eventCount and a < packet.eventCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_EVENT_EXT, ResourceID(packet.pEvents[a]), iter, frame_id );
		}
	...
	case VKTRACE_TPI_VK_vkDestroySurfaceKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_INSTANCE_EXT, ResourceID(packet.instance), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SURFACE_KHR_EXT, ResourceID(packet.surface), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateSwapchainKHR : {
		...
		if ( packet.pSwapchain ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SWAPCHAIN_KHR_EXT, ResourceID(*packet.pSwapchain), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroySwapchainKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SWAPCHAIN_KHR_EXT, ResourceID(packet.swapchain), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetSwapchainImagesKHR : {
		...
		for (uint a = 0; packet.pSwapchainImages and &packet.pSwapchainImageCount[0] and a < packet.pSwapchainImageCount[0]; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, ResourceID(packet.pSwapchainImages[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateSharedSwapchainsKHR : {
		...
		for (uint a = 0; packet.pSwapchains and &packet.swapchainCount and a < packet.swapchainCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SWAPCHAIN_KHR_EXT, ResourceID(packet.pSwapchains[a]), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateWin32SurfaceKHR : {
		...
		if ( packet.pSurface ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SURFACE_KHR_EXT, ResourceID(*packet.pSurface), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDescriptorUpdateTemplateKHR : {
		...
		if ( packet.pDescriptorUpdateTemplate ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_EXT, ResourceID(*packet.pDescriptorUpdateTemplate), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyDescriptorUpdateTemplateKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_EXT, ResourceID(packet.descriptorUpdateTemplate), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkUpdateDescriptorSetWithTemplateKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_EXT, ResourceID(packet.descriptorSet), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_EXT, ResourceID(packet.descriptorUpdateTemplate), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetDisplayModePropertiesKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.physicalDevice), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_KHR_EXT, ResourceID(packet.display), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateDisplayModeKHR : {
		...
		if ( packet.pMode ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_MODE_KHR_EXT, ResourceID(*packet.pMode), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetDisplayPlaneCapabilitiesKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.physicalDevice), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_MODE_KHR_EXT, ResourceID(packet.mode), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateIndirectCommandsLayoutNVX : {
		...
		if ( packet.pIndirectCommandsLayout ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NVX_EXT, ResourceID(*packet.pIndirectCommandsLayout), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyIndirectCommandsLayoutNVX : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NVX_EXT, ResourceID(packet.indirectCommandsLayout), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateObjectTableNVX : {
		...
		if ( packet.pObjectTable ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_OBJECT_TABLE_NVX_EXT, ResourceID(*packet.pObjectTable), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyObjectTableNVX : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_OBJECT_TABLE_NVX_EXT, ResourceID(packet.objectTable), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetRandROutputDisplayEXT : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.physicalDevice), iter, frame_id );
		if ( packet.pDisplay ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_KHR_EXT, ResourceID(*packet.pDisplay), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateSamplerYcbcrConversionKHR : {
		...
		if ( packet.pYcbcrConversion ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SAMPLER_YCBCR_CONVERSION_EXT, ResourceID(*packet.pYcbcrConversion), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroySamplerYcbcrConversionKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_SAMPLER_YCBCR_CONVERSION_EXT, ResourceID(packet.ycbcrConversion), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkGetDisplayPlaneSupportedDisplaysKHR : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, ResourceID(packet.physicalDevice), iter, frame_id );
		if ( packet.pDisplays ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_KHR_EXT, ResourceID(*packet.pDisplays), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkCreateValidationCacheEXT : {
		...
		if ( packet.pValidationCache ) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT, ResourceID(*packet.pValidationCache), iter, frame_id );
		}
		break;
	}
	...
	case VKTRACE_TPI_VK_vkDestroyValidationCacheEXT : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT, ResourceID(packet.validationCache), iter, frame_id );
		break;
	}
	...
	case VKTRACE_TPI_VK_vkMergeValidationCachesEXT : {
		...
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT, ResourceID(packet.device), iter, frame_id );
		_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT, ResourceID(packet.dstCache), iter, frame_id );
		for (uint a = 0; packet.pSrcCaches and &packet.srcCacheCount and a < packet.srcCacheCount; ++a) {
			_AddResourceBookmark( VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT, ResourceID(packet.pSrcCaches[a]), iter, frame_id );
		}
		break;
	}
