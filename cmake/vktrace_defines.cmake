...
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
	set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_WIN32_KHR" "WIN32_LEAN_AND_MEAN" )
	set(DisplayServer Win32)

elseif(CMAKE_SYSTEM_NAME STREQUAL "Android")
	set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_ANDROID_KHR" )

elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")

	if (BUILD_WSI_XCB_SUPPORT)
		set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_XCB_KHR" )
	endif()

	if (BUILD_WSI_XLIB_SUPPORT)
		set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_XLIB_KHR" )
	endif()

	if (BUILD_WSI_WAYLAND_SUPPORT)
		set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_WAYLAND_KHR" )
	endif()

	if (BUILD_WSI_MIR_SUPPORT)
		# TODO Add Mir Support
		# set( VTC_CONVERTER_DEFINES "${VTC_CONVERTER_DEFINES}" "VK_USE_PLATFORM_MIR_KHR" )
